...
Many of the methods defined on Neo objects construct these linkages.
...
Once this hierarchy has been created, the user may iterate over the data in whatever way is most intuitive for the application: either temporally (trial by trial within a session) or spatially (channel by channel within the brain).
