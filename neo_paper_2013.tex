...
To that end, we propose here a language-independent object model suitable for representing data acquired from electroencephalographic, intracellular or extracellular recordings, or generated from simulations. 
As a concrete instantiation of this object model we have developed Neo, an open source implementation in the Python programming language.
